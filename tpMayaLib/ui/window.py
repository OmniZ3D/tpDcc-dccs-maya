...
from tpQtLib.widgets import framelesswindow
...
class MayaFramelessWindow(framelesswindow.FramelessWindow, object):
    def __init__(self, *args, **kwargs):
        super(MayaFramelessWindow, self).__init__(*args, **kwargs)
...
tpQtLib.FramelessWindow = MayaFramelessWindow
